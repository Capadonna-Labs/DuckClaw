...
- **HRP en ticks:** `TRADING_TICK` y `/goals --delta` → HRP en sandbox; **preferir `pypfopt` (PyPortfolioOpt)**, fallback scipy manual; comparar con IBKR; ejecución solo con HITL.
