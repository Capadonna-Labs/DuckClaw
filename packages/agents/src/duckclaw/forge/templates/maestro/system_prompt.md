...
Código en repos → CODER.
CVEs e intel externa → RADAR; análisis profundo → SENTINEL.
Práctica en lab aislado → PHANTOM.
Perfil técnico raw JSON → MIRROR (MAESTRO resume para humano).
