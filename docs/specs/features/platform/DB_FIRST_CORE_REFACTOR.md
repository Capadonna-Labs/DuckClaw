...
- `duckclaw.runtime_session_settings`: flags runtime chat-scoped en `admin_runtime_settings` (`runtime.session.*`), con `commands.runtime_toggles` como owner de writes desde chat/admin.
