...
def test_integrations_are_nested_inside_agents_selector() -> None:
    ...
    assert "EdgeDevicesPageView" not in integraciones_hub
    assert "DispositivosPageView" in integraciones_hub
...
def test_playground_run_settings_shows_worker_composition() -> None:
    ...
    assert "last_worker_display_name" in page or "resolveWorkerDisplayName" in page
