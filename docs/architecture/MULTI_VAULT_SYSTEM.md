...
> **Diseño (esta doc)** · **Operación:** `uv run duckops doctor` + [`../GETTING_STARTED.md`](../GETTING_STARTED.md).
...
La resolución de rutas ocurre en `build_worker_graph` (`packages/agents/src/duckclaw/workers/factory.py`):
