"""read_pool: envoltorio finanz deudas con total sin doble conteo Compra agregada + cuotas."""
...
def test_maybe_wrap_finanz_deudas_dedup_mac_mini_aggregate_plus_cuotas() -> None:
    ...
    rows = [
        {
            "id": "18",
            "description": "Compra - TC Banco Ejemplo - 12 cuotas",
            "amount": "2360000.0",
            "creditor": "TC Bancolombia",
        },
        {"id": "5", "description": "Compra - Cuota Enero 2026", "amount": "295000.0", "creditor": "TC Bancolombia"},
        {"id": "6", "description": "Compra - Cuota Febrero 2026", "amount": "295000.0", "creditor": "TC Bancolombia"},
        {"id": "13", "description": "Mueble - Cuota Marzo 2026", "amount": "150000.0", "creditor": "Proveedor"},
    ...
    assert meta["suma_todas_las_filas_cop"] == 2360000.0 + 295000.0 * 2 + 150000.0 + 3850.0
    assert meta["total_recomendado_resumen_cop"] == 2360000.0 + 150000.0 + 3850.0
