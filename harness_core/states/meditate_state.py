"""Pydantic models and TypedDict for the meditate infrastructure thermostat."""
...
class DomainGoal(BaseModel):
    """Domain goal contrasted by meditate alongside infra metrics."""
...
class HomeostasisManifest(BaseModel):
    """Single source of truth: infra thresholds + domain goals for /meditate contrast."""
...
class MeditateState(TypedDict, total=False):
    """LangGraph state for meditate runs."""
