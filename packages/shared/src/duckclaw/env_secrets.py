...
DOTENV_OVERRIDE_KEYS: frozenset[str] = frozenset(
    ...
    | {
        ...
        "IBKR_EXECUTE_ORDER_URL",
        "IBKR_EXECUTE_ACCOUNT_EQUITY_USD",
        "IBKR_EXECUTE_ORDER_TIMEOUT_SEC",
...
DOTENV_OWNED_ENV_KEYS: frozenset[str] = frozenset(
    {
        ...
        "DUCKCLAW_SENSORY_BASE_URL",
        "DUCKCLAW_SENSORY_BIND_HOST",
        "DUCKCLAW_SENSORY_PORT",
        "DUCKCLAW_SENSORY_AUDIO_TOKENIZER_MODEL",
        "DUCKCLAW_SENSORY_AUDIO_TOKENIZER_PATH",
        "DUCKCLAW_SENSORY_TTS_TIMEOUT_MS",
        "DUCKCLAW_SENSORY_TTS_MAX_CHARS",
        "DUCKCLAW_SENSORY_TTS_MAX_DURATION_SEC",
        "DUCKCLAW_SENSORY_TTS_NUM_STEPS",
        "DUCKCLAW_SENSORY_TTS_MODEL",
        "PYTHONPATH",
    }
)
