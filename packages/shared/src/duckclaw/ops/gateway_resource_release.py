...
def release_worker_graph_cache(*, force: bool = True) -> dict[str, Any]:
    """
    Vacía la caché LRU de grafos LangGraph + catálogo capabilities y fuerza ``gc.collect()``.
    ...
    from duckclaw.ops.worker_capabilities_catalog_cache import (
        clear_worker_capabilities_catalog_cache,
        worker_capabilities_catalog_cache_entry_count,
        worker_capabilities_catalog_cache_stats,
    )

    entries_before = worker_graph_cache_entry_count()
    caps_before = worker_capabilities_catalog_cache_entry_count()
    ...
    caps_after = worker_capabilities_catalog_cache_entry_count()
    ...
    return {
        ...
        "worker_capabilities_catalog_cache": worker_capabilities_catalog_cache_stats(),
        "capabilities_catalog_entries_before": caps_before,
        "capabilities_catalog_entries_after": caps_after,
    }
