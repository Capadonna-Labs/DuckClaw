...
- `tests/test_worker_factory_modular_boundaries.py`: protege que `template_registry`, `load_manifest` y `workers.factory.list_workers` expongan desde filesystem solo `default`; agentes extra deben venir de DB/catalogo.
